...
void generate_all_white_rooks_moves(Bitboard white_rooks, Bitboard black_occupency, Bitboard all_occupency, MoveList* move_list);
void generate_all_black_rooks_moves(Bitboard black_rooks, Bitboard white_occupency, Bitboard all_occupency, MoveList* move_list);
