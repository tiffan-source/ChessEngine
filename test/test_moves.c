...
void test_CREATE_MOVE_should_handle_minimum_values(void)
{
    ...
    TEST_ASSERT_EQUAL(BLACK_PAWN, GET_PIECE_TYPE(move));
    TEST_ASSERT_EQUAL(QUIET_MOVES, GET_MOVE_TYPE(move));
}
...
void test_CREATE_MOVE_should_handle_maximum_values(void)
{
    ...
    TEST_ASSERT_EQUAL(WHITE_KING, GET_PIECE_TYPE(move));
    TEST_ASSERT_EQUAL(QUEEN_PROMOTION_CAPTURE, GET_MOVE_TYPE(move));
}
...
void test_CREATE_MOVE_should_handle_quiet_pawn_move(void)
{
    ...
    TEST_ASSERT_EQUAL(WHITE_PAWN, GET_PIECE_TYPE(move));
    TEST_ASSERT_EQUAL(QUIET_MOVES, GET_MOVE_TYPE(move));
}
...
void test_CREATE_MOVE_should_handle_double_pawn_push(void)
{
    ...
    TEST_ASSERT_EQUAL(WHITE_PAWN, GET_PIECE_TYPE(move));
    TEST_ASSERT_EQUAL(DOUBLE_PAWN_PUSH, GET_MOVE_TYPE(move));
}
...
void test_CREATE_MOVE_should_handle_king_castle(void)
{
    ...
    TEST_ASSERT_EQUAL(WHITE_KING, GET_PIECE_TYPE(move));
    TEST_ASSERT_EQUAL(KING_CASTLE, GET_MOVE_TYPE(move));
}
...
void test_CREATE_MOVE_should_handle_queen_castle(void)
{
    ...
    TEST_ASSERT_EQUAL(WHITE_KING, GET_PIECE_TYPE(move));
    TEST_ASSERT_EQUAL(QUEEN_CASTLE, GET_MOVE_TYPE(move));
}
...
void test_CREATE_MOVE_should_handle_capture(void)
{
    ...
    TEST_ASSERT_EQUAL(WHITE_KNIGHT, GET_PIECE_TYPE(move));
    TEST_ASSERT_EQUAL(CAPTURE, GET_MOVE_TYPE(move));
}
...
void test_CREATE_MOVE_should_handle_en_passant_capture(void)
{
    ...
    TEST_ASSERT_EQUAL(WHITE_PAWN, GET_PIECE_TYPE(move));
    TEST_ASSERT_EQUAL(EN_PASSANT_CAPTURE, GET_MOVE_TYPE(move));
}
...
void test_CREATE_MOVE_should_handle_knight_promotion(void)
{
    ...
    TEST_ASSERT_EQUAL(WHITE_PAWN, GET_PIECE_TYPE(move));
    TEST_ASSERT_EQUAL(KNIGHT_PROMOTION, GET_MOVE_TYPE(move));
}
...
void test_CREATE_MOVE_should_handle_bishop_promotion(void)
{
    ...
    TEST_ASSERT_EQUAL(E8, GET_DESTINATION_SQUARE(move));
    TEST_ASSERT_EQUAL(WHITE_PAWN, GET_PIECE_TYPE(move));
    TEST_ASSERT_EQUAL(BISHOP_PROMOTION, GET_MOVE_TYPE(move));
}
...
void test_CREATE_MOVE_should_handle_rook_promotion(void)
{
    ...
    TEST_ASSERT_EQUAL(E8, GET_DESTINATION_SQUARE(move));
    TEST_ASSERT_EQUAL(WHITE_PAWN, GET_PIECE_TYPE(move));
    TEST_ASSERT_EQUAL(ROOK_PROMOTION, GET_MOVE_TYPE(move));
}
...
void test_CREATE_MOVE_should_handle_queen_promotion(void)
{
    ...
    TEST_ASSERT_EQUAL(E8, GET_DESTINATION_SQUARE(move));
    TEST_ASSERT_EQUAL(WHITE_PAWN, GET_PIECE_TYPE(move));
    TEST_ASSERT_EQUAL(QUEEN_PROMOTION, GET_MOVE_TYPE(move));
}
...
void test_CREATE_MOVE_should_handle_knight_promotion_capture(void)
{
    ...
    TEST_ASSERT_EQUAL(WHITE_PAWN, GET_PIECE_TYPE(move));
    TEST_ASSERT_EQUAL(KNIGHT_PROMOTION_CAPTURE, GET_MOVE_TYPE(move));
}
...
void test_CREATE_MOVE_should_handle_bishop_promotion_capture(void)
{
    ...
    TEST_ASSERT_EQUAL(F8, GET_DESTINATION_SQUARE(move));
    TEST_ASSERT_EQUAL(WHITE_PAWN, GET_PIECE_TYPE(move));
    TEST_ASSERT_EQUAL(BISHOP_PROMOTION_CAPTURE, GET_MOVE_TYPE(move));
}
...
void test_CREATE_MOVE_should_handle_rook_promotion_capture(void)
{
    ...
    TEST_ASSERT_EQUAL(F8, GET_DESTINATION_SQUARE(move));
    TEST_ASSERT_EQUAL(WHITE_PAWN, GET_PIECE_TYPE(move));
    TEST_ASSERT_EQUAL(ROOK_PROMOTION_CAPTURE, GET_MOVE_TYPE(move));
}
...
void test_CREATE_MOVE_should_handle_all_black_pieces(void)
{
    ...
    TEST_ASSERT_EQUAL(BLACK_BISHOP, GET_PIECE_TYPE(move3));
    TEST_ASSERT_EQUAL(BLACK_ROOK, GET_PIECE_TYPE(move4));
    TEST_ASSERT_EQUAL(BLACK_QUEEN, GET_PIECE_TYPE(move5));
    TEST_ASSERT_EQUAL(BLACK_KING, GET_PIECE_TYPE(move6));
}
...
void test_CREATE_MOVE_should_handle_boundary_squares(void)
{
    ...
    TEST_ASSERT_EQUAL(H1, GET_SOURCE_SQUARE(move2));
    TEST_ASSERT_EQUAL(A1, GET_DESTINATION_SQUARE(move2));
    TEST_ASSERT_EQUAL(A1, GET_SOURCE_SQUARE(move3));
    TEST_ASSERT_EQUAL(A8, GET_DESTINATION_SQUARE(move3));
    TEST_ASSERT_EQUAL(H8, GET_SOURCE_SQUARE(move4));
    TEST_ASSERT_EQUAL(H1, GET_DESTINATION_SQUARE(move4));
}
...
void test_CREATE_MOVE_should_isolate_bit_fields(void)
{
    ...
    Square dest = GET_DESTINATION_SQUARE(move);
    PieceType piece = GET_PIECE_TYPE(move);
