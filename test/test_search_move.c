...
void test_should_return_evaluation_at_depth_0(void)
{
    ...
    set_depth(0);
    ScoredMove evaluation = nega_alpha_beta(game, 0, MIN, MAX, 0);
...
void test_should_identify_checkmate_in_one_move(void)
{
    ...
    set_depth(2);
    ScoredMove evaluation = nega_alpha_beta(game, 2, MIN, MAX, 0);
...
void test_should_identify_checkmate_in_two_move(void)
{
    ...
    set_depth(4);
    ScoredMove evaluation = nega_alpha_beta(game, 4, MIN, MAX, 0);
...
void test_should_identify_material_advantage_for_white(void)
{
    ...
    set_depth(1);
    ScoredMove evaluation = nega_alpha_beta(game, 1, MIN, MAX, 0);
...
void test_should_identify_checkmate_in_three_move_for_black(void)
{
    ...
    set_depth(6);
    ScoredMove evaluation = nega_alpha_beta(game, 6, MIN, MAX, 0);
