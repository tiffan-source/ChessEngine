...
void test_generate_all_type_white_pawn_move_from_tricky_position(void)
{
    ...
    generate_all_white_pawns_moves(game_white->white_pawns, BLACK_OCCUPENCY(game_white), ALL_OCCUPENCY(game_white), game_white->en_passant_target_square, result_for_white);
...
void test_generate_all_type_black_pawn_move_from_tricky_position(void)
{
    ...
    generate_all_black_pawns_moves(game_black->black_pawns, WHITE_OCCUPENCY(game_black), ALL_OCCUPENCY(game_black), game_black->en_passant_target_square, result_for_black);
...
void test_generate_all_pawns_move_from_position_without_en_passant(void)
{
    ...
    generate_all_black_pawns_moves(game->black_pawns, WHITE_OCCUPENCY(game), ALL_OCCUPENCY(game), game->en_passant_target_square, result);
...
void test_generate_all_white_pawns_capture_moves_from_position(void)
{
    ...
    generate_all_white_pawns_capture_moves(game->white_pawns, BLACK_OCCUPENCY(game), ALL_OCCUPENCY(game), game->en_passant_target_square, result);
...
void test_generate_all_black_pawns_capture_moves_from_position(void)
{
    ...
    generate_all_black_pawns_capture_moves(game->black_pawns, WHITE_OCCUPENCY(game), ALL_OCCUPENCY(game), game->en_passant_target_square, result);
