...
void test_generate_all_white_queens_move_from_tricky_position(void)
{
    ...
    ScoredMove expected_for_white[] = {
        CREATE_SCORED_MOVE(D1, C2, WHITE_QUEEN, QUIET_MOVES),
        CREATE_SCORED_MOVE(D1, B3, WHITE_QUEEN, QUIET_MOVES),
        CREATE_SCORED_MOVE(D1, C1, WHITE_QUEEN, QUIET_MOVES),
        CREATE_SCORED_MOVE(D1, B1, WHITE_QUEEN, QUIET_MOVES),
        CREATE_SCORED_MOVE(D1, E1, WHITE_QUEEN, QUIET_MOVES),
        CREATE_SCORED_MOVE(D1, E2, WHITE_QUEEN, QUIET_MOVES),
    };
    
    generate_all_white_queens_moves(game_white->white_queens, BLACK_OCCUPENCY(game_white), ALL_OCCUPENCY(game_white), result_for_white);
...
void test_generate_all_white_queens_move_from_Kiwipete_position(void)
{
    ...
    ScoredMove expected_for_white[] = {
        CREATE_SCORED_MOVE(F3, F4, WHITE_QUEEN, QUIET_MOVES),
        CREATE_SCORED_MOVE(F3, F5, WHITE_QUEEN, QUIET_MOVES),
        CREATE_SCORED_MOVE(F3, F6, WHITE_QUEEN, CAPTURE),

        CREATE_SCORED_MOVE(F3, E3, WHITE_QUEEN, QUIET_MOVES),
        CREATE_SCORED_MOVE(F3, D3, WHITE_QUEEN, QUIET_MOVES),

        CREATE_SCORED_MOVE(F3, G3, WHITE_QUEEN, QUIET_MOVES),
        CREATE_SCORED_MOVE(F3, H3, WHITE_QUEEN, CAPTURE),

        CREATE_SCORED_MOVE(F3, G4, WHITE_QUEEN, QUIET_MOVES),
...
void test_generate_all_black_queens_move_from_tricky_position(void)
{
    ...
    ScoredMove expected_for_black[] = {
        CREATE_SCORED_MOVE(A3, A4, BLACK_QUEEN, CAPTURE),
        CREATE_SCORED_MOVE(A3, B4, BLACK_QUEEN, CAPTURE),
        CREATE_SCORED_MOVE(A3, B3, BLACK_QUEEN, QUIET_MOVES),
        CREATE_SCORED_MOVE(A3, C3, BLACK_QUEEN, QUIET_MOVES),
        CREATE_SCORED_MOVE(A3, D3, BLACK_QUEEN, QUIET_MOVES),
        CREATE_SCORED_MOVE(A3, E3, BLACK_QUEEN, QUIET_MOVES),
        CREATE_SCORED_MOVE(A3, F3, BLACK_QUEEN, CAPTURE),
        CREATE_SCORED_MOVE(A3, A2, BLACK_QUEEN, CAPTURE),
    };
    
    generate_all_black_queens_moves(game_black->black_queens, WHITE_OCCUPENCY(game_black), ALL_OCCUPENCY(game_black), result_for_black);
...
void test_generate_all_black_queens_capture_from_tricky_position(void)
{
    ...
    generate_all_black_queens_captures(game_black->black_queens, WHITE_OCCUPENCY(game_black), ALL_OCCUPENCY(game_black), result_for_black);
...
void test_generate_all_white_queens_mcapture_from_tricky_position(void)
{
    ...
    generate_all_white_queens_captures(game_white->white_queens, BLACK_OCCUPENCY(game_white), ALL_OCCUPENCY(game_white), result_for_white);
    ...
    assert_move_lists_equal(expected_for_black, result_for_white->moves, 2);
    free_game(game_white);
