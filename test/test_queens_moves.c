...
//     qsort(result_for_black->moves, result_for_black->current_index, sizeof(ScoredMove), compare_move);
//     qsort(expected_for_black, 8, sizeof(ScoredMove), compare_move);
...
//     qsort(result_for_black->moves, result_for_black->current_index, sizeof(ScoredMove), compare_move);
//     qsort(expected_for_black, 4, sizeof(ScoredMove), compare_move);
...
//     qsort(result_for_white->moves, result_for_white->current_index, sizeof(ScoredMove), compare_move);
//     qsort(expected_for_black, 2, sizeof(ScoredMove), compare_move);
